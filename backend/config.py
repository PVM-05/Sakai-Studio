...
from backend.tools.constant import SubtitleDetectMode, InpaintMode as InpaintModeGUI
import os
import sys
import configparser
...
class Config(QConfig):
    ...
    poissonBlending = ConfigItem("Main", "PoissonBlending", False, BoolValidator())
