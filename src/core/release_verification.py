...
from src.core.dependency_caps import (
...
from src.video_ops.ffmpeg_profiles import collect_ffmpeg_capability_profiles
from src.ai_engines.onnx_model_info import rapidocr_release_provenance
from src.ai_engines.remote_model_policy import release_remote_model_status
from src.core.security_checks import opencv_libpng_status
...
def _run_reference_corpus(timeout_note: str = "local release") -> dict:
    ...
    try:
        from src.core.reference_corpus import run_reference_corpus
