...
from src.core.import_safety import module_can_import as _safe_module_can_import
...
def run_ffmpeg_whisper_segments(
    ...
    try:
        from src.core.io import _ffmpeg_subprocess_timeout, _probe_duration_seconds
