...
from src.core.language_support import language_support_status
from src.ai_engines.remote_model_policy import resolve_remote_model_source
...
def _pynv_decode_status(env: Mapping[str, str]) -> dict:
    try:
        from src.video_ops.decode_accel import pynv_decode_status
...
def _adapter_hash_status(adapter_name: str, model_path: Optional[str]) -> dict:
    from src.core.adapter_manifest import verify_adapter_path
